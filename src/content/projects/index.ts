...
export const projectIds = ["ai-voice-agent", "invoice-automation", "kyc-processing", "ai-project-2", "ai-project-3", "ai-project-4", "ticket-management", "workflow-automation", "incident-management"];
